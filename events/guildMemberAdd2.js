...
Canvas.registerFont('./font/KidsMagazine.ttf', { family: 'Kids Magazine' });
var welcomeCanvas = {}
welcomeCanvas.create = Canvas.createCanvas(1024, 500)
welcomeCanvas.context = welcomeCanvas.create.getContext('2d')
welcomeCanvas.context.font = '50px "Kids Magazine"';
welcomeCanvas.context.fillStyle = '#ffffff';

Canvas.loadImage('./img/bg.png').then(async (img) => {
   welcomeCanvas.context.drawImage(img, 0, 0, 1024, 500)
   welcomeCanvas.context.fillText("WELCOME", 350, 360)
...
client.on('guildMemberAdd', async member => {
 ...
 canvas.context.font = '30px "Kids Magazine"';
